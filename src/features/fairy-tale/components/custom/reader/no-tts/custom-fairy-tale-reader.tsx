...
import { useCustomFairyTaleReaderStandaloneContext } from "@/features/fairy-tale/hooks/use-custom-fairy-tale-reader-standalone-context";
...
function Root({ children }: { children: React.ReactNode }) {
  const { nextPage, prevPage, isOverlayOpen, setIsOverlayOpen } = useCustomFairyTaleReaderStandaloneContext();
